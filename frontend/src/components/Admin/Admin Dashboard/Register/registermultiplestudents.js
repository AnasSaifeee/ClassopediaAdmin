...
function StudentRegister() {
  ...
  async function RegisterAll(e) {
    ...
    const response = await fetch("https://classopedia.onrender.com/registerall", {
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div className="height100vh">
        <div className="text-center"> <h2 className="text-dark fw-bolder fs-2 mb-3" id="head-9">Register Multipe Students</h2></div>
